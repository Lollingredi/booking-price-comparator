...
function StepBanner({ hotelChosen, competitorsChosen }: { hotelChosen: boolean; competitorsChosen: boolean }) {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 px-4 py-2.5 flex items-center justify-center gap-1 shrink-0">
      ...
      <span className="text-gray-300 dark:text-slate-600 text-sm mx-1 sm:mx-2">→</span>
    ...
    <div className="h-screen overflow-hidden flex flex-col bg-gray-50 dark:bg-slate-900">
      ...
      <div className="lg:hidden flex shrink-0 bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700">
        <button
          ...
          className={`flex-1 py-2.5 text-sm font-medium transition-colors ${mobileView === "map" ? "text-teal-600 border-b-2 border-teal-600" : "text-gray-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-slate-200"}`}
        >
          🗺 Mappa
        </button>
        <button
          onClick={() => setMobileView("list")}
          className={`flex-1 py-2.5 text-sm font-medium transition-colors ${mobileView === "list" ? "text-teal-600 border-b-2 border-teal-600" : "text-gray-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-slate-200"}`}
        >
                ...
                <div className="bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800 rounded-xl p-4 shrink-0">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <button
                      ...
                      className="text-gray-400 dark:text-slate-500 hover:text-gray-600 dark:hover:text-slate-300 text-lg leading-none shrink-0 mt-0.5"
                    >✕</button>
                  </div>
                </div>
